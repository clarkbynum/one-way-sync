...
function edgeDisconnected(_a) {
  var req = _a.req,
      resp = _a.resp,
      _b = _a.cacheName,
      cacheName = _b === void 0 ? shared_1.DEFAULT_EDGE_RELAY_CACHE_NAME : _b; //We don't want this service to run on the platform
...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var _clearblade_one_way_sync_edge_edge_disconnected__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _clearblade_one_way_sync_edge_edge_disconnected__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_clearblade_one_way_sync_edge_edge_disconnected__WEBPACK_IMPORTED_MODULE_0__);
 // @ts-ignore

global.edgeDisconnected = _clearblade_one_way_sync_edge_edge_disconnected__WEBPACK_IMPORTED_MODULE_0___default.a;
